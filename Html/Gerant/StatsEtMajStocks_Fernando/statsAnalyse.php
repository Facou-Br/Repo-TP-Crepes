...
<body>
    <form>
        ...
        <div class="containerTwo">
            ...
            <input type="week" id="numeroSemaine" name="numeroSemaine" title="numeroSemaine" class="periodeSemaine">
        </div>

        <div class="containerThree">
            <label for="periodeJour">Période de jour:</label>
            <label for="dateJour">Le</label>
            <input type="date" id="dateJour" name="dateJour" title="dateJour" class="periodeJour">
        </div>
        ...
        <input type="submit" value="Valider" id="valider" name="valider" title="valider">
    </form>

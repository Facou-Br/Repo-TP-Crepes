...
INSERT INTO `produit` (`NomProd`, `Active`, `Taille`, `NbIngBase`, `NbIngOpt`, `PrixUHT`, `Image`, `IngBase1`, `IngBase2`, `IngBase3`, `IngBase4`, `IngBase5`, `IngOpt1`, `IngOpt2`,
                       `IngOpt3`, `IngOpt4`, `IngOpt5`, `IngOpt6`, `NbOptMax`, `DateArchiv`) VALUES
                                                                                                 ('Crepes Suzette', '1', 'M', 3, 2, 5, '/jpeg/breton.jpg', 'Farine', 'Oeufs', 'Lait', 'Sucre', 'Beurre', 'Orange', 'Grand Marnier', 'Zeste d\'orange', 'Sucre Vanillé', 'Banane', 'Chantilly', 2, '0000-00-00'),
                                                                                                 ('Crêpe Kebab', '1', 'M', 3, 2, 8, '/jpeg/kebab.jpg', 'Tomate', 'Salade', 'Oignon', 'Poivron', 'Ail', 'Boeuf', 'Persil', 'Sauce Soja', 'Paprika', 'Huile', 'Vinaigre Balsamique', 2, '0000-00-00'),
                                                                                                 ('Crêpe aux fruits de saison', '1', 'M', 3, 2, 6, 'jpeg/fruitsaison.jpg', 'Fraise', 'Banane', 'Chantilly', 'Sucre', 'Lait', 'Persil', 'Basilic', 'Ciboulette', 'Tomate', 'Huile', 'Reblochon', 2, '0000-00-00'),
                                                                                                 ('Crêpe aux fruits de mer', '1', 'M', 3, 2, 9, 'jpeg/fruitdemer.jpg', 'Crevettes', 'Saumon', 'Thon', 'Ail', 'Oignon', 'Huile', 'Persil', 'Basilic', 'Ciboulette', 'Lait', 'Reblochon', 2, '0000-00-00'),
...
INSERT INTO `fournisseur` (`NomFourn`, `Adresse`, `CodePostal`, `Ville`, `Tel`, `DateArchiv`) VALUES
                                                                                                  ...
                                                                                                  ('Casino', '148 Rue de Universite', '75007', 'PARIS', '01 53 65 24 00', '0000-00-00'),
...
INSERT INTO `commande` (`NomClient`, `TelClient`, `AdrClient`, `CP_Client`, `VilClient`, `Date`, `HeureDispo`, `TypeEmbal`, `A_Livrer`, `EtatCde`, `EtatLivraison`, `CoutLiv`, `TotalTTC`, `DateArchiv`, `IdLivreur`) VALUES
                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                          ('MOREAU', '01 02 03 04 10', '18 rue de la Paix', '75000', 'PARIS', '2019-01-01', '12:45:00', 'Sac', 1, 'Acceptée', 'en_livraison', 5, 10, '0000-00-00', 6),
